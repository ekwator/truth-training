...
**Research Output**: `[/specs/008-specify-md/research.md](research.md)(/[specs/008-specify-md/research.md](research.md))` (updated 2025-11-17)
...
**Artifacts Generated**:
- `[/specs/008-specify-md/data-model.md](data-model.md)(/[specs/008-specify-md/data-model.md](data-model.md))` – Node entity schema, validation rules, migration strategy, Room/Rust struct parity.
- `/specs/008-specify-md/contracts/nodes-api.yaml` – OpenAPI spec for node listing, discovery trigger, sync, CRUD, health.
- `[/specs/008-specify-md/contracts/README.md](contracts/README.md)(/[specs/008-specify-md/contracts/README.md](contracts/README.md))` – Contract usage + testing guidance.
- `[/specs/008-specify-md/quickstart.md](quickstart.md)(/[specs/008-specify-md/quickstart.md](quickstart.md))` – Seven scenario validation guide covering schema parity, LAN discovery, sync, TTL cleanup, reachability, cross-platform DB, merge priority (local-over-global).
