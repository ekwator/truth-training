...
See [CHANGELOG.md](https://github.com/ekwator/truth-training/blob/master/CHANGELOG.md#100--first-stable-baseline--context-fields-embedded) for complete details.
