<!-- Archived from [[truth-android-client/CHANGELOG.md](truth-android-client/CHANGELOG.md)](CHANGELOG.md) -->
...
See [[docs/TEST_REPORT_ANDROID_v1.0.0.md](docs/TEST_REPORT_ANDROID_v1.0.0.md)](../docs/TEST_REPORT_ANDROID_v1.0.0.md) for detailed test results.
...
- **Test Report**: [[docs/TEST_REPORT_ANDROID_v1.0.0.md](docs/TEST_REPORT_ANDROID_v1.0.0.md)](../docs/TEST_REPORT_ANDROID_v1.0.0.md)
- **CI/CD Workflows**: [[docs/CI_Workflows_Artifacts.md](docs/CI_Workflows_Artifacts.md)](../docs/CI_Workflows_Artifacts.md)
