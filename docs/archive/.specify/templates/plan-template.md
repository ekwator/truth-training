...
**Input**: Feature specification from `/specs/[###-feature-name][/[spec.md](spec.md)](/spec.md)`

**Note**: This template is filled in by the `/speckit.plan` command. See `[.[specify/templates/commands/plan.md](specify/templates/commands/plan.md)](.specify/templates/commands/plan.md)` for the execution workflow.
