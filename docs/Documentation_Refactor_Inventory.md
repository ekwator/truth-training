...
- **Audience classification**: Use the `audience` field to confirm that root-level entry points (`[README.md](README.md)`, `[docs/README.md](docs/README.md)`, `[spec/README.md](spec/README.md)`) are correctly identified.
