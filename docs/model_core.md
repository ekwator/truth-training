...
📌 Only this "state" allows for the **consent** of the **event**  
"status" defines the temporal phase of the **event** :  
...
• Even when stable, events can be "reactivated" by new **judgments** or **impacts**, at
which point entries in history or stability may be updated.
