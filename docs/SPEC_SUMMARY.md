...
- **Documentation**: [docs/Concept_Collective_Intelligence.md](Concept_Collective_Intelligence.md)
...
- **Documentation**: [docs/api_reference/API_REFERENCE.md](api_reference/API_REFERENCE.md)

### CLI Integration
- **truthctl**: Administrative CLI for node management
- **Features**: Peer management, key generation, diagnostics
- **Documentation**: [docs/CLI_Usage.md](CLI_Usage.md)`, `[spec/10-cli.md](../spec/10-cli.md)
